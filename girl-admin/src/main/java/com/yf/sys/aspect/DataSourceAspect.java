...
import com.yf.sys.annotation.DataSource;
import com.yf.sys.support.orm.db.DataSourceEnum;
import com.yf.sys.support.orm.db.DynamicDataSource;
...
public class DataSourceAspect {
    ...
    @Pointcut("@annotation(com.yf.sys.annotation.DataSource)")
