package com.yf.base.config.shrio;

import com.yf.base.config.Global;
import com.yf.base.config.redis.RedisCacheManager;
...
//        shiroFilterFactoryBean.setSecurityManager(defaultWebSecurityManager());
        ...
        shiroFilterFactoryBean.setLoginUrl("/sys/goLogin");
        // 登录成功后要跳转的链接
    ...
    public SimpleMappingExceptionResolver simpleMappingExceptionResolver() {
        ...
        properties.setProperty("IOException","/common/error/403");
